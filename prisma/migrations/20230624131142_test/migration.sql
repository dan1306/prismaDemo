...
-- CreateTable
CREATE TABLE "UserPrefeance" (
    "id" TEXT NOT NULL,
    "emailUpdates" BOOLEAN NOT NULL,
    "userId" TEXT NOT NULL,

    CONSTRAINT "UserPrefeance_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "UserPrefeance_userId_key" ON "UserPrefeance"("userId");
...
-- AddForeignKey
ALTER TABLE "UserPrefeance" ADD CONSTRAINT "UserPrefeance_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
